...
namespace CsharpToPython
{
    ...
    public class AsynchronousClient
    {
        ...
        public void connect(int port_loc = 11000)
        {
            port = port_loc;
            ipHostInfo = Dns.GetHostEntry("127.0.0.1"); //Dns.GetHostName());
            int len = ipHostInfo.AddressList.Length - 1;
            ipAddress = ipHostInfo.AddressList[len];
